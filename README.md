...
If LiveCue helps you learn from a LIVE room, a star would mean a lot. It helps this small open-source project get discovered by more creators and builders.

如果 LiveCue 帮你从一个直播间里学到了一点东西，欢迎点一个 Star。它会帮助这个小小的开源项目被更多创作者和开发者看见。
